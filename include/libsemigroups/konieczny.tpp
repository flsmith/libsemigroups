...
namespace libsemigroups {
  ...
  template <typename T>
  void Konieczny<Element, Traits>::add_generators(T const& first, T const& last) {
    if (started()) {
  ...
  void Konieczny<Element, Traits>::validate_element_collection(Iterator first, Iterator last) const {
  ...
  template <typename Element, typename Traits>
  template <typename T>
  struct Konieczny<Element, Traits>::DClassIteratorTraits : detail::ConstIteratorTraits<std::vector<T*>> {
